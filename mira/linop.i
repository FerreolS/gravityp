 ...
 *-----------------------------------------------------------------------------
 *
 *	Copyright (C) 2007 Eric Thiébaut <thiebaut@obs.univ-lyon1.fr>
 *
 ...
 *
 * History:
 *	$Id: linop.i,v 1.9 2008/07/12 06:51:13 eric Exp $
 *	$Log: linop.i,v $
 ...
 *	 - New functions: linop_cast_real_as_complex to
 *	   linop_cast_complex_as_real cast 2-by-any real
 *	   arrays as complex arrays and vice-versa.
 *	 - New function linop_reshape to change an array
 *	   dimension list and type without conversion.
 *	 - New function linop_make_matrix to build the matrix
 ...
 *	 - Fixed function linop_new for a sparse matrix (thanks to
 *         Thierry Michel).
 *
 ...
 *	Now JOB can indicate inverse and inverse transpose linear
 *	transform.
 *
