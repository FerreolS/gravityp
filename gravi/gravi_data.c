 ...
 * @param clip_thresh     threshold on the standard deviation 
 *
 * Cosmic ray hits are identified as outliers when they are more than 5 
 * times the standard deviation estimated using the median absolute deviation
 *  from the median computed across the list of images. This is evaluated on a 
 * pixel-by-pixel basis. CR pixels are interpolated along the row of an image.
 */
/*---------------------------------------------------------------------------*/
