...
/**
 * @defgroup gravi_strehl  Strehl computation related functions
 */
/**@{*/
...
/**
  ...
  @return   CPL_ERROR_NONE if there were no errors. 
            CPL_ERROR_INCOMPATIBLE_INPUT if wavelength is negative.
 */
/*----------------------------------------------------------------------------*/
