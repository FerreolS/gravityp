...
cpl_error_code * gravi_imagelist_filter_cosmicrays (cpl_imagelist * imglist,
                                    double threshold_factor);

cpl_mask * gravi_imagelist_blinking_map_create (cpl_imagelist * imglist)
