                       ...
                       cpl_parameterlist * parlist)
{
    ...
    if (averageSky == 1) {
        ...
        gravi_data_save_new (msky_map, frameset, NULL, NULL,
                             parlist, sky_frameset,
    ...
    for (int ivis = 0; ivis < nb_frame; ivis++){
        ...
        if (gravi_param_get_bool (parlist,"gravity.test.reduce-acq-cam")) {
            gravi_reduce_acqcam (p2vmred_data, preproc_data, sky_maps[isky], dark_map, static_param_data);
        }
        ...
        gravi_compute_pointing_uv (p2vmred_data, eop_map);
